      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-[#69995D]/20 to-[#007FFF]/20 rounded-full flex items-center justify-center">
              <Bookmark className="w-16 h-16 text-[#504B3A]/40" />
            </div>
            <h3 className="text-2xl font-semibold text-[#504B3A] mb-2">No bookmarks yet</h3>
            <p className="text-[#504B3A]/60 mb-8">Start exploring PGs and save your favorites here</p>
            <button 
              onClick={() => navigate("/filter")}
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <button className="w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-red-50 transition-colors">
                      <Heart className="w-5 h-5 text-red-500 fill-current" />
                    </button>
                  </div>
                  <div className="absolute top-4 left-4">
                    <span className="bg-[#007FFF] text-white px-3 py-1 rounded-full text-xs font-semibold">
                      Bookmarked
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="font-bold text-lg text-[#504B3A] group-hover:text-[#69995D] transition-colors">
                      {listing.name}
                    </h3>
                    {listing.rating && (
                      <div className="flex items-center gap-1">
                        <Star className="w-4 h-4 text-yellow-400 fill-current" />
                        <span className="text-sm font-semibold text-[#504B3A]">{listing.rating}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs px-3 py-1 bg-[#69995D]/10 text-[#69995D] rounded-full font-medium">
                      {listing.gender}
                    </span>
                  </div>
